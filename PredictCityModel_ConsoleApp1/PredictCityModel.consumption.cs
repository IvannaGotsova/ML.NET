...
namespace PredictCityModel_ConsoleApp1
{
    ...
    {
        /// <summary>
        /// model input class for PredictCityModel.
        /// </summary>
        ...
        /// <summary>
        /// model output class for PredictCityModel.
        /// </summary>
        ...
        private static string MLNetModelPath = Path.GetFullPath("PredictCityModel.mlnet");
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("city");
            if (labelColumn == null)
            {
                throw new Exception("city column not found. Make sure the name searched for matches the name in the schema.");
            }
