...
namespace PredictPromotionModel_2_ConsoleApp3
{
    public partial class PredictPromotionModel
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(new []{new InputOutputColumnPair(@"department,", @"department,"),new InputOutputColumnPair(@"last_name,", @"last_name,"),new InputOutputColumnPair(@"city,", @"city,"),new InputOutputColumnPair(@"country,", @"country,"),new InputOutputColumnPair(@"experience,", @"experience,"),new InputOutputColumnPair(@"salary", @"salary")}, outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
