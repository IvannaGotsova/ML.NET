...
namespace PredictPromotionModel_ConsoleApp2
{
    public partial class PredictPromotionModel
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.ReplaceMissingValues(new []{new InputOutputColumnPair(@"person_id,", @"person_id,"),new InputOutputColumnPair(@"age,", @"age,"),new InputOutputColumnPair(@"rating,", @"rating,"),new InputOutputColumnPair(@"experience,", @"experience,"),new InputOutputColumnPair(@"salary", @"salary")})      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastTree(new FastTreeBinaryTrainer.Options(){NumberOfLeaves=222,MinimumExampleCountPerLeaf=13,NumberOfTrees=20,MaximumBinCountPerFeature=281,FeatureFraction=0.585394293230952,LearningRate=6.35757701694393E-05,LabelColumnName=@"promotion,",FeatureColumnName=@"Features"}),labelColumnName: @"promotion,"))      
